...
def main():
    ...
    list_page = 3
    # 列表信息文件名
    jd_listFile_name = "E:/python_project/spider-study/spider_05/jd_common_datas/jd_getList_kouhong.csv"
    # 将搜索url复制到这里
    url = f'https://search.jd.com/Search?keyword=%E5%8F%A3%E7%BA%A2&enc=utf-8&wq=%E5%8F%A3%E7%BA%A2&pvid=65c5d786064b4317a32ae3db8b97c232'
    # 令牌信息
