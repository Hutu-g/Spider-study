...
def main():
    ...
    # url文件
    com_url_file = "E:/python_project/spider-study/spider_05/jd_common_datas/jd_getList_kouhong.csv"
    # 写入文件目录
    com_file_name = "E:/python_project/spider-study/spider_05/jd_common_datas/jd_getDetail_kouhong.csv"
    # 令牌信息
